                      ...
                      title: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: const [
                            ...
                            Text('Bliss', style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold)),
                            Text('Bliss@gmail.com', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w500)),

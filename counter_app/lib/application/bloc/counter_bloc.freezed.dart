...
/// @nodoc
abstract class _$$_CounterSateCopyWith<$Res>
    implements $CounterStateCopyWith<$Res> {
  factory _$$_CounterSateCopyWith(
          _$_CounterSate value, $Res Function(_$_CounterSate) then) =
      __$$_CounterSateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int count});
}
...
/// @nodoc
class __$$_CounterSateCopyWithImpl<$Res>
    extends _$CounterStateCopyWithImpl<$Res, _$_CounterSate>
    implements _$$_CounterSateCopyWith<$Res> {
  __$$_CounterSateCopyWithImpl(
      _$_CounterSate _value, $Res Function(_$_CounterSate) _then)
      : super(_value, _then);
...
class _$_CounterSate implements _CounterSate {
  const _$_CounterSate({required this.count});
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_CounterSateCopyWith<_$_CounterSate> get copyWith =>
      __$$_CounterSateCopyWithImpl<_$_CounterSate>(this, _$identity);
}

abstract class _CounterSate implements CounterState {
  const factory _CounterSate({required final int count}) = _$_CounterSate;
